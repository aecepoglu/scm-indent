...
(define (foo refmt? stack0 l0)
        (define (aux col stack state acc l)
                (match (cons state l)
                       ...
                       (('code #\" tl ...)       (aux (+ 1 col) (cons (+ 1 col) stack)        'string (cons #\" acc)          tl))
                       (('string #\\ #\" tl ...) (aux (+ 1 col) (cons (+ 1 col) stack)        'string (append '(#\\ #\") acc) tl))
                       (('string #\" tl ...)     (aux (+ 1 col) (cons (+ 1 col) stack)        'code   (cons #\" acc)          tl))
